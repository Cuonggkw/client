...
async function postMenu(data: dataType) {
    try {
        await fetch(`http://localhost:8080/restautant.com/v1/api/menus/create`, {
            method: 'POST',
...
async function updateMenu(data: dataType) {
    try {
        await fetch(`http://localhost:8080/restautant.com/v1/api/menus/update`, {
            method: 'PUT',
            body: JSON.stringify(data),
            headers: {
                'content-type': 'application/json',
...
async function deleteMenu(data: dataType) {
    try {
        await fetch(`http://localhost:8080/restautant.com/v1/api/menus/delete`, {
            method: 'DELETE',
            body: JSON.stringify(data),
            headers: {
                'content-type': 'application/json',
